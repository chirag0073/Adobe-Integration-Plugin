		...
		<div class="col-md-2 col-lg-3 col-sm-3 col-xs-6">
				<div class="image_box">
							...
							<div class="media_item">
								...
								<a href="<?php echo $data['thumbnail_url'];?>" data-rel="prettyPhoto" title="<?php echo $data['title'];?>" data-thumbnail_url="<?php echo $data['thumbnail_url'];?>" data-id="<?php echo $data['id'];?>" data-type="media" data-title="<?php echo $data['title'];?>"  data-stock_id="<?php echo $data['stock_id'];?>" onclick="//get_media(this);">
								<img class="lazy-load" data-src="<?php echo $data['thumbnail_url']; ?>" data-srcset="<?php echo $data['thumbnail_url']; ?>" >
								</a>
							</div>
							<div class="fusion-product-content">
									...
									<div class="product-buttons">
										...
										<div class="product-buttons-container clearfix">
											...
											<button type="submit" class="fusion-button button-default fusion-button-default-size button create" name="create" value="create" data-thumbnail_url="<?php echo $data['thumbnail_url'];?>" data-name="<?php echo $data['title'];?>" data-stock-id="<?php echo $data['stock_id'];?>" onclick="create_adobe_product(this);">Create</button>
										</div>
									</div>
							</div>
				</div>
